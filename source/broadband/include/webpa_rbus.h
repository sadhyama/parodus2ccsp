...
typedef WDMP_STATUS (*dataModelCMCCallBack)(char* data);

typedef WDMP_STATUS (*dataModelCIDCallBack)(char *str);

typedef WDMP_STATUS (*dataModelSyncVersionCallBack)(char* version);

WDMP_STATUS regWebpaDataModel(dataModelCMCCallBack dmCMCCallBack, dataModelCIDCallBack dmCIDCallBackHandler, dataModelSyncVersionCallBack dmSyncVersionCallBackHandler);
